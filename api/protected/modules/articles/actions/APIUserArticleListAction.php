 ...
 * @version 2.0
 */
class APIUserArticleListAction extends CAction
{
	/**
	 ...
	 * @return return list of articles of user.
	 */
	public function run($user_id ='', $limit = 10, $page = 0, $fields = '', $parts = '')
	{
		ApiAccess::allow("GET");

		$binUserId = IDHelper::uuidToBinary($user_id);
		$user = ZoneUser::model()->getUserInfo($binUserId);
		if ($user->id === -1) {
