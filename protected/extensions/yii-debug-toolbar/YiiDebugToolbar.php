...
class YiiDebugToolbar extends CWidget {
	...
	private function registerClientScripts() {
		...
		GNAssetHelper::setBase('ext.yii-debug-toolbar.assets');
		GNAssetHelper::setPriority(50);
		
		GNAssetHelper::cssFile('yii.debugtoolbar');
		GNAssetHelper::scriptFile('cookie', CClientScript::POS_END);
		GNAssetHelper::scriptFile('yii.debugtoolbar', CClientScript::POS_END);
