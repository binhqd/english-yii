...
class ZoneReportConcern extends GNActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('verifyCode', 'captcha', 'allowEmpty' => !CCaptcha::checkRequirements(), 'on' => 'concern'),
			array('id, IP, cookie, dns_name, user_agent, user_id, object_id, object_type, content, is_archive', 'safe', 'on'=>'search'),
		);
	}
	...
	*/
	public function getAll($mediaType=null, $limit=50){
		$criteria = new CDbCriteria();
		if(isset($mediaType)){
			$criteria->condition = 'media_type=:mediaType';
