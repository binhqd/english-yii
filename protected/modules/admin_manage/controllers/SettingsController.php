...
class SettingsController extends JLController
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Settings']))
		{
			...
			Yii::app()->settings->set($_POST['Settings']['category'], $_POST['Settings']['key'], $_POST['Settings']['value']); 
	...
	public function actionUpdate($id)
	{
		...
		//dump(Yii::app()->settings->get('Business package'));
		if(isset($_POST['Settings']))
		{
			Yii::app()->settings->set($_POST['Settings']['category'], $_POST['Settings']['key'], $_POST['Settings']['value']); 
			$this->redirect(array('index'));
